...
namespace BaseDeDatos.Tablas
{
    public class Eventos : BaseDeDatos
    {
        ...
        public string EventoInsert(prop.Eventos item)
        {
            ...
            CreateTextCommand(consulta);
            AddParameter("?",item.NombreEvento, OleDbType.VarChar, 255);
