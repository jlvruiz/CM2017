<%@ Page Title="" Language="C#" MasterPageFile="~/CM.Master" AutoEventWireup="true" CodeBehind="frmClienteInterno.aspx.cs" Inherits="CM2017.Admin.frmClienteInterno" ErrorPage="~/Error.aspx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <h2><%= objClienteInterno._title %></h2>
    ...
    <div>
        ...
        <div id="divEncima" style="position: fixed; z-index: 151; top: 0; width: 100%; height: 100%; display: none">
            ...
            <div style="background-color: white; width: 25%; height:25%; position: relative; top: 15%; left: 30%; border:1px solid orange;">
                ...
                <div style="padding: 15px">
                    ...
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkActivo" runat="server" CssClass="radio-inline"  /></td>
                        </tr>
                        <tr><td colspan="2">&nbsp;</td></tr>
