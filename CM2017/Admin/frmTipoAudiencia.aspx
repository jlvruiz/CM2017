<%@ Page Title="" Language="C#" MasterPageFile="~/CM.Master" AutoEventWireup="true" CodeBehind="frmTipoAudiencia.aspx.cs" Inherits="CM2017.Admin.frmTipoAudiencia" %>
        ...
        <div id="divEncima" style="position: fixed; z-index: 151; top: 0; width: 100%; height: 100%; display: none">
            ...
            <div style="background-color: #161665; color: white; width: 100%; height: 30px;">
                ...
                <table>
                    ...
                    <tr><td colspan="5" align="center"><asp:Button ID="btnAceptar" runat="server" Text="Aceptar" CssClass="btn btn-primary" OnClick="btnAceptar_Click" /></td></tr>
                </table>
